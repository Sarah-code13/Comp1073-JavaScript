...
function Coffee(size, isDecaf, qtyCream, qtySugar){
    ...
    this.description = function(){
        //a small sized caffeinated coffee with 1 cream and 2 sugar.
...
let sarahCoffee = new Coffee("medium", false, 2,1);
output.textContent = sarahCoffee.description();
...
let robertCoffee = Object.create(sarahCoffee);
